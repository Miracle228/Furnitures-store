...
public class Main {
    ...
    public static void main(String args[]){
       ...
       Items mirror = new Items();
        ...
        System.out.println("First furnitures: " + items.get(0));
        System.out.println("Second furnitures: " + items.get(1));
        System.out.println("Last furnitures: " + items.get(items.size()-1));

        //#Removing elements from an ArrayList
        System.out.println("========= #Removing elements from an ArrayList");
        items.remove(2);
        System.out.println("Frunitures size: " + items.size());
